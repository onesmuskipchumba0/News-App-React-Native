...
const Technology = () => {
    ...
    const endpoint = "https://newsapi.org/v2/top-headlines?category=technology&apiKey=4a94ea88a9fd4b5a8589436afb76e038";
    ...
    return (
        <View className='flex-1'>
          ...
          <OffCanvas isOpen={isMenuOpen} onClose={() => setIsMenuOpen(false)} />
            <Text className='font-semibold text-xl w-full text-center m-4'>Technology News</Text>
            <ScrollView>
            {loading ? (
